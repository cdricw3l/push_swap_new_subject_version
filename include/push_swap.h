...
/*   Updated: 2026/06/02 11:39:02 by mabrugge         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				associate_one_target(t_best_cost *cur, t_target_result target,
					t_global_data *data);
...
void			init_best_cost(t_best_cost *best, t_global_data *data, int stack, int *ptr);
int				get_target_number(t_global_data *data, int stack, t_list **lst);
